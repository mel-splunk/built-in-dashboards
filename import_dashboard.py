...
with signalfx.SignalFx(
    ...
    for i, chart in enumerate(charts):
        ...
        print(f"""terraform import {tf_type}.{dashboard_name}_{i} {chart["chartId"]}; terraform state show -no-color {tf_type}.{dashboard_name}_{i} | grep -v url | grep -v -E "id *" | pbcopy""")
